...
- 歷史文件（`Plan_git_time_machine_improvement_spec.md`、`Plan_git_time_machine_improvement2.md`，2026-07-19 os-conform 依文件前綴表自 `git-time-machine-improvement-spec.md`/`improvement2.md` 改名）為存檔性質，內容未改動。
